...
public class MainActivity extends AppCompatActivity {
    ...
    public void click(View view) { //xml에 연결되어 있는 페이지
        switch (view.getId()) {
    ...
    private void showDialog(String num) { //데이터를 사용하는 페이지 이니 조심하라는 문구
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("이 기능은 데이터를 사용할 수 있습니다. 사용하시겠습니까?")
                ...
                .setNegativeButton("아니오", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getApplicationContext(), "아니오 선택했습니다.", Toast.LENGTH_LONG).show();
                    }
                })
                .create()
                .show();
