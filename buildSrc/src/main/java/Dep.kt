...
object Dep {
  ...
  object AndroidX {
    ...
    object Compose {
      ...
      const val materialAdapter = "com.google.android.material:compose-theme-adapter:1.2.0"
      ...
      const val viewModel =
          "androidx.lifecycle:lifecycle-viewmodel-compose:${AndroidX.lifecycle.lifecycleVersion}"
    }
